        ...
        with(binding) {
            radioGroup.setOnCheckedChangeListener { _, checkedId ->
                when (checkedId) {
                    R.id.radio1 -> {
                        textField.hint = "사진검색"
                        textField.startIconDrawable = resources.getDrawable(R.drawable.ic_baseline_photo_library_24, resources.newTheme())
                        this@MainActivity.searchType = SEARCH_TYPE.PHOTO
                    }
                    R.id.radio2 -> {
                        textField.hint = "사용자검색"
                        textField.startIconDrawable = resources.getDrawable(R.drawable.ic_baseline_user_24, resources.newTheme())
